...
ROOT_DIR = environ.Path(__file__) - 3  # (nomad_coders/config/settings/base.py - 3 = nomad_coders/)
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres://localhost/nomad_coders'),
}
